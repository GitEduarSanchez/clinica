...
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-edit"></i> Gestión de Ecografías</h3></div>
<div class="panel-body">
<div class="row">
    ...
    <div class="form-group has-feedback"> 
      ...
      <?php } ?>
        ...
        <?php } ?>
            ...
            <div class="modal-footer"> 
<button type="button" onClick="BuscarEcografia()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                          </div>
