...
if ($_SESSION['acceso'] == "general" || $_SESSION["acceso"]=="ginecologo" || $_SESSION["acceso"]=="laboratorio" || $_SESSION["acceso"]=="radiologo" || $_SESSION["acceso"]=="terapeuta" || $_SESSION["acceso"]=="odontologo") {

$tra = new Login();
$ses = $tra->ExpiraSession();
$exp = $tra->Expiro();

$reg = $tra->MedicosSessionPorId();
...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-edit"></i> Actualizar Mis Datos</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li><a href="panel">Control</a></li>
...
<form class="form" name="updatemedicosession" id="updatemedicosession" method="post" data-id="<?php echo $reg[0]["codmedico"] ?>" action="#" enctype="multipart/form-data">

<div class="row">
<div class="col-sm-12">
<div class="panel panel-primary">
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-edit"></i> Actualizar Mis Datos</h3></div>
...
<input type="text" class="form-control" name="cedmedico" id="cedmedico" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Nº de Identificación" <?php if (isset($reg[0]['cedmedico'])) { ?> value="<?php echo $reg[0]['cedmedico']; ?>"<?php } ?> required="" aria-required="true">
  ...
  <input type="text" class="form-control" name="apemedico" id="apemedico" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Apellidos" <?php if (isset($reg[0]['apemedico'])) { ?> value="<?php echo $reg[0]['apemedico']; ?>"<?php } ?>>
                        <i class="fa fa-pencil form-control-feedback"></i>  
                              </div> 
                        </div>
                    </div>
