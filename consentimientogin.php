...
<h3 class="panel-title"><i class="fa fa-tasks"></i> Control de Consentimiento<span class="pull-right"><a href="forconsentimientogin" class="btn btn-default dropdown-toggle" data-toggle="tooltip" data-placement="left" title="" data-original-title="Nuevo Consentimiento"><span class="fa fa-folder-open"></span> Nuevo Consentimiento</a></span></h3>
</div>
...
<?php 
$reg = new Login();
$reg = $reg->ListarConsentimientoGinecologo();
...
<?php if ($_SESSION['acceso'] == "administrador"){ ?><a class="btn btn-danger btn-xs" onClick="eliminar('eliminar?<?php echo base64_encode('eliminar'); ?>&codconsentimiento=<?php echo base64_encode($reg[$i]["codconsentimiento"]) ?>&tipo=<?php echo base64_encode("CONSENTIMIENTOGINECOLOGIA") ?>')" title="Eliminar" ><i class="fa fa-trash-o"></i></a><?php } ?></td>
											   </tr>
											   <?php } } ?>
											   </tbody>
</table>
