...
<form class="form" method="post"  action="#" name="formulasterapias" id="formulasterapias" onSubmit="asigna()"> 

<div class="row">
<div class="col-sm-12">
<div class="panel panel-primary">
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-edit"></i> Gestión de Fórmulas Terapias</h3></div>
...
<button type="button" onClick="BuscarFormulasTerapias()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                          </div>
                        ...
                        <div id="muestraformulaterapia"></div>
                        <div id="crearformulaterapia"></div>
