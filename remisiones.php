...
<h3 class="panel-title"><i class="fa fa-tasks"></i> Control de Remisiones<span class="pull-right"><a href="forremision" class="btn btn-default dropdown-toggle" data-toggle="tooltip" data-placement="left" title="" data-original-title="Nueva Remisión"><span class="fa fa-file-text"></span> Nueva Remisión</a></span></h3>
</div>
...
<a class="btn btn-primary btn-xs" title="Editar" onClick="actualizar('editremision?r=<?php echo base64_encode($reg[$i]["codprocedimiento"]) ?>')"><i class="fa fa-pencil"></i></a>
