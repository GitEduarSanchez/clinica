...
{
$reg = $tra->RegistrarOrdenesMedicas();
exit;
}
?>
<!DOCTYPE html>
...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-edit"></i> Gestión de Órdenes Médicas</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li><a href="ordenesmedicas">Control</a></li>
<li class="active">Gestión de Órdenes</li>
</ol>
...
<form class="form" method="post"  action="#" name="ordenesmedicas" id="ordenesmedicas" onSubmit="asigna()"> 

<div class="row">
<div class="col-sm-12">
<div class="panel panel-primary">
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-edit"></i> Gestión de Órdenes Médicas</h3></div>
...
<button type="button" onClick="BuscarOrdenesMedicas()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                          </div>
                        ...
                        <div id="muestraordenmedica"></div>
                        <div id="crearordenmedica"></div>
