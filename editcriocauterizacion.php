...
{
$reg = $tra->ActualizarCriocauterizacion();
exit;
}
?>
<!DOCTYPE html>
...
<form class="form" name="updatecriocauterizacion" id="updatecriocauterizacion" method="post" data-id="<?php echo $reg[0]["codprocedimiento"] ?>" action="#" onSubmit="asigna()"> 
