...
{
$reg = $tra->ActualizarFormulasMedicas();
exit;
}
?>
<!DOCTYPE html>
...
<form class="form" name="updateformulamedicag" id="updateformulamedicag" method="post" data-id="<?php echo $reg[0]["codprocedimiento"] ?>" action="#" onSubmit="asigna()"> 
...
<input name="codformula" type="hidden" id="codformula" value="<?php echo $reg[0]['codformula']; ?>" />
