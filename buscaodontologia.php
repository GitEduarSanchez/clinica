...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-search"></i> Búsqueda en Odontología</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li><a href="odontologia">Control</a></li>
<li class="active">Búsqueda en Odontología</li>
</ol>
...
<form class="form" method="post"  action="#" name="buscareporteodontologia" id="buscareporteodontologia"> 
      

<div class="row">
<div class="col-sm-12">
<div class="panel panel-primary">
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-search"></i> Búsqueda en Odontología</h3></div>
...
<button type="button" onClick="BuscarReporteOdontologia()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                          </div>
         ...
         <div id="muestrareporteodontologia"></div>
