...
if(isset($_POST["registrar"]) and $_POST["registrar"]=="ok")
{
$reg = $tra->RegistrarTerapias();
exit;
}
elseif(isset($_POST["update"]) and $_POST["update"]=="okk")
{
$reg = $tra->AgregarTerapias();
exit;
}
?>
<!DOCTYPE html>
...
<form class="form" method="post"  action="#" name="terapias" id="terapias" onSubmit="asigna()"> 

<div class="row">
<div class="col-sm-12">
<div class="panel panel-primary">
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-edit"></i> Gestión de Terapias</h3></div>
  ...
  <div class="col-md-4"> 
    <div class="form-group has-feedback"> 
      ...
      <select name="codmedico" id="codmedico" class='form-control' required="" aria-required="true">
       ...
       <?php
       $med = new Login();
       $med = $med->ListarMedicosEspecialidadTerapeuta();
...
<button type="button" onClick="BuscarTerapia()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                          </div>
                        ...
                        <div id="muestraterapia"></div>
                        <div id="crearterapia"></div>
...
myNewCell.innerHTML='<div class="col-md-12"><div class="form-group has-feedback"><label class="control-label">Atención/Actividad y/o Tratamiento: <span class="symbol required"></span></label><textarea name="tratamientoterapia[]'+cont+'" class="form-control" id="tratamientoterapia'+cont+'" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Atención/Actividad y/o Tratamiento de Terapia" title="Ingrese Tratamiento de Terapias" rows="3" required="" aria-required="true"></textarea><i class="fa fa-pencil form-control-feedback"></i></div></div>';
myNewCell=myNewRow.insertCell(-1);
myNewCell.innerHTML='<div class="col-md-12"><div class="form-group has-feedback"><label class="control-label">Fecha de Terapia: <span class="symbol required"></span></label><input class="form-control calendario" type="text" name="fechaterapia[]'+cont+'" id="fechaterapia'+cont+'" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" value="<?php echo date('d-m-Y'); ?>" title="Ingrese Fecha de Terapia" required="" aria-required="true"><i class="fa fa-calendar form-control-feedback"></i></div></div>';
myNewCell=myNewRow.insertCell(-1);
myNewCell.innerHTML='<div class="col-md-12"><div class="form-group has-feedback"><label class="control-label">Hora de Terapia: <span class="symbol required"></span></label><input name="horaterapia[]'+cont+'" id="horaterapia'+cont+'" type="text" value="<?php echo date("h:i:s"); ?>" class="form-control hour" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" title="Ingrese Hora de Terapia" required="" aria-required="true"><i class="fa fa-clock-o form-control-feedback"></i></div></div>';
indiceFila++;
}
