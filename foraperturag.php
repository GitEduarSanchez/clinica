...
<form class="form" method="post"  action="#" name="aperturag" id="aperturag" onSubmit="asigna()"> 
...
<button type="button" onClick="BuscarAperturaG()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>
            </div>
