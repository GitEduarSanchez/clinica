...
<form class="form" method="post"  action="#" name="formulasmedicasg" id="formulasmedicasg" onSubmit="asigna()"> 
...
<button type="button" onClick="BuscarFormulasMedicasG()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                          </div>
