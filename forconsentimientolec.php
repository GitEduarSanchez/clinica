...
<form class="form" method="post"  action="#" name="consentimientolec" id="consentimientolec"> 
...
<input type="hidden" name="especialidad" id="especialidad" value="RADIOLOGO">
...
<button type="button" onClick="BuscarConsentimientoLec()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                          </div>
