...
<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><img src="assets/images/close.png"/></button> 
             <h3 class="panel-title"><i class="fa fa-align-justify"></i> Datos de Sede</h3> 
                                                        </div> 
                                                        <div class="panel-body"> 
                                                         <div id="muestrasedemodal"></div>
                                                        </div>
...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Control de Sedes</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li class="active">Control de Sedes</li>
</ol>
...
<div class="panel-heading">
<h3 class="panel-title"><i class="fa fa-tasks"></i> Control de Sedes<span class="pull-right">
...
<li><a href="forsedes" data-toggle="tooltip" data-placement="left" title="" data-original-title="Nueva Sede"><i class="fa fa-plus"></i> Nuevo</a></li>
<li><a href="reportepdf?tipo=<?php echo base64_encode("SEDES") ?>" target="_blank" rel="noopener noreferrer" data-toggle="tooltip" data-placement="left" title="" data-original-title="Listado (Pdf)"><i class="fa fa-file-pdf-o"></i> Listado (Pdf)</a></li>
<li><a href="reporteexcel?tipo=<?php echo base64_encode("SEDES") ?>" data-toggle="tooltip" data-placement="left" title="" data-original-title="Listado (Excel)"><i class="fa fa-file-excel-o"></i> Listado (Excel)</a></li>
            </ul>
</div>
</span></h3>
</div>
		...
		if(isset($_GET["mesage"]))
{
	switch($_GET["mesage"])
	{
		...
		echo "<center><span class='fa fa-check-square-o'></span> LA SEDE FUE ELIMINADA EXITOSAMENTE </center>"; 
		echo "</div>";
		break;
		...
		echo "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
		echo "<center><span class='fa fa-info-circle'></span> ESTA SEDE NO PUEDE SER ELIMINADA, SE ENCUENTRA ASIGNADA A UNA CITA MEDICA </center>";  
		echo "</div>"; 
		break;
    ...
    echo "<div class='alert alert-warning'>";
    echo "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
    echo "<center><span class='fa fa-info-circle'></span> USTED NO PUEDE ELIMINAR SEDES, NO ERES EL ADMINISTRADOR </center>";  
    echo "</div>"; 
    break;
...
<td><abbr title="<?php echo "SUCURSAL: ".$reg[$i]['nombresucursal']; ?>"><?php echo $reg[$i]['nombresede']; ?></abbr></td>
											...
											<td><?php echo $reg[$i]['nomdirecsede']." ".$reg[$i]['apedirecsede']; ?></td>
											   <td>
<a class="btn btn-success btn-xs" data-placement="left" title="Ver" data-original-title="" data-href="#" data-toggle="modal" data-target="#panel-modal" data-backdrop="static" data-keyboard="false" onClick="VerSede('<?php echo base64_encode($reg[$i]["codsede"]); ?>')"><i class="fa fa-eye"></i></a>

<a class="btn btn-primary btn-xs" title="Editar" onClick="actualizar('forsedes?codsede=<?php echo base64_encode($reg[$i]["codsede"]) ?>')"><i class="fa fa-pencil"></i></a>
                                 
<a class="btn btn-danger btn-xs" onClick="eliminar('eliminar?<?php echo base64_encode('eliminar'); ?>&codsede=<?php echo base64_encode($reg[$i]["codsede"]) ?>&tipo=<?php echo base64_encode("SEDES") ?>')" title="Eliminar" ><i class="fa fa-trash-o"></i></a> </td>
											   </tr>
											   <?php } } ?>
											   </tbody>
</table>
