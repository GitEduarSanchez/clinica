...
imagen1.src="fotos/img_colpos.png"; //asignar imagen al objeto-imagen
...
<form class="form" method="post"  action="#" name="colposcopias" id="colposcopias" onSubmit="asigna()"> 

<div class="row">
<div class="col-sm-12">
<div class="panel panel-primary">
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-edit"></i> Gestión de Colposcopias</h3></div>
...
<button type="button" onClick="BuscarColposcopias()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                          </div>
                        ...
                        <div id="muestracolposcopias"></div>
                        <div id="crearcolposcopias"></div>
