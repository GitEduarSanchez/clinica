...
<li><a href="consentimientolec">Control</a></li>
...
<form class="form" method="post"  action="#" name="consentimientoter" id="consentimientoter"> 
...
<input type="hidden" name="especialidad" id="especialidad" value="TERAPEUTA">
...
<button type="button" onClick="BuscarConsentimientoTer()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                          </div>
