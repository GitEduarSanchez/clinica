...
{
$reg = $tra->RegistrarFormulasMedicas();
exit;
}
?>
<!DOCTYPE html>
...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-edit"></i> Gestión de Fórmulas Médicas</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li><a href="formulasmedicas">Control</a></li>
<li class="active">Gestión de Fórmulas</li>
</ol>
...
<form class="form" method="post"  action="#" name="formulasmedicas" id="formulasmedicas" onSubmit="asigna()"> 

<div class="row">
<div class="col-sm-12">
<div class="panel panel-primary">
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-edit"></i> Gestión de Fórmulas Médicas</h3></div>
  ...
  <div class="col-md-4"> 
    <div class="form-group has-feedback"> 
      ...
      <select name="codmedico" id="codmedico" class='form-control' required="" aria-required="true">
       ...
       <?php
       $med = new Login();
       $med = $med->ListarMedicosEspecialidadGeneral();
...
<button type="button" onClick="BuscarFormulasMedicas()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                          </div>
                        ...
                        <div id="muestraformulamedica"></div>
                        <div id="crearformulamedica"></div>
