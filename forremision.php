...
<form class="form" method="post"  action="#" name="remisiones" id="remisiones" onSubmit="asigna()"> 

<div class="row">
<div class="col-sm-12">
<div class="panel panel-primary">
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-edit"></i> Gestión de Remisiones</h3></div>
...
<button type="button" onClick="BuscarRemisiones()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                          </div>
                        ...
                        <div id="muestraremision"></div>
                        <div id="crearremisiones"></div>
