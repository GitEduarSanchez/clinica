...
{
$reg = $tra->RegistrarLecturaRx();
exit;
}
elseif(isset($_POST["procesar"]) and $_POST["procesar"]=="ok")
{
$reg = $tra->ProcesarLecturaRx();
exit;
}
?>
<!DOCTYPE html>
...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-edit"></i> Gestión de Lecturas RX</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li><a href="lecturarx">Control</a></li>
<li class="active">Gestión de Lecturas RX</li>
</ol>
...
<form class="form" method="post"  action="#" name="radiologia" id="radiologia"> 

<div class="row">
<div class="col-sm-12">
<div class="panel panel-primary">
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-edit"></i> Gestión de Lecturas RX</h3></div>
<div class="panel-body">
<div class="row">
    ...
    <div class="form-group has-feedback"> 
      ...
      <?php } ?>
        ...
        <?php } ?>
            ...
            <div class="modal-footer"> 
<button type="button" onClick="BuscarRadiologia()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                          </div>
                        ...
                        <div id="muestraradiologia"></div>
                        <div id="crearradiologia"></div>
