...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-edit"></i> Gestión de Consentimiento</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li><a href="consentimientogin">Control</a></li>
<li class="active">Gestión de Consentimiento</li>
</ol>
...
<form class="form" method="post"  action="#" name="consentimientogin" id="consentimientogin"> 
      

<div class="row">
<div class="col-sm-12">
<div class="panel panel-primary">
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-edit"></i> Gestión de Consentimiento</h3></div>
...
<div class="col-sm-12 col-xs-12">
        ...
        <div class="row">
                ...
                <div class="col-md-3"> 
                      ...
                      <input name="tipom" id="optradio1" type="radio" class="radio" value="1" checked="checked">
            <label for="optradio1" class="control-label"><strong>Consent. de Aperturas:</strong></label>
                              </div>
                           </div> 
                </div>
                ...
                <div class="col-md-3"> 
                            <div class="form-group"> 
                                <div class="radio radio-primary">
                     <input name="tipom" id="optradio2" type="radio" class="radio" value="2">
              <label for="optradio2" class="control-label"><strong>Consent. de Ecografías:</strong></label>
                                </div>
                            </div> 
                </div>
                ...
                <div class="col-md-3"> 
                            <div class="form-group">
                                  <div class="radio radio-primary">
                    <input name="tipom" id="optradio3" type="radio" class="radio" value="3">
              <label for="optradio3" class="control-label"><strong>Consent. de Mamografías:</strong></label>
                                 </div>                                                                  
                            </div> 
                </div>
                ...
                <div class="col-md-3"> 
                            <div class="form-group">
                               <div class="radio radio-primary">
                    <input name="tipom" id="optradio4" type="radio" class="radio" value="4">
             <label for="optradio4" class="control-label"><strong>Consent. de Tomografías:</strong></label>
                               </div>                                                                  
                            </div> 
                  </div>
             </div>
...
<input type="hidden" name="especialidad" id="especialidad" value="GINECOLOGIA">
  ...
  <div class="col-md-5"> 
    <div class="form-group has-feedback"> 
      ...
      <select name="codmedico" id="codmedico" class='form-control' required="" aria-required="true">
       ...
       <?php
       $med = new Login();
       $med = $med->ListarMedicosEspecialidadBacteriologo();
...
<button type="button" onClick="BuscarConsentimientoGin()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                          </div>
