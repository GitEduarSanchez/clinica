...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Control de Fórmulas Médicas</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li class="active">Fórmulas Médicas</li>
</ol>
...
<h3 class="panel-title"><i class="fa fa-tasks"></i> Control de Fórmulas Médicas<span class="pull-right"><a href="forfmedicag" class="btn btn-default dropdown-toggle" data-toggle="tooltip" data-placement="left" title="" data-original-title="Nueva Fórmula"><span class="fa fa-file-text"></span> Nueva Fórmula</a></span></h3>
</div>
		...
		if(isset($_GET["mesage"]))
{
	switch($_GET["mesage"])
	{
		...
		echo "<center><span class='fa fa-check-square-o'></span> LA FÓRMULA MÉDICA FUE ELIMINADA EXITOSAMENTE </center>"; 
		echo "</div>";
		break;
    ...
    echo "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
    echo "<center><span class='fa fa-info-circle'></span> USTED NO PUEDE ELIMINAR FÓRMULAS MÉDICAS, NO ERES EL ADMINISTRADOR </center>";  
    echo "</div>"; 
    break;
...
<?php 
$reg = new Login();
$reg = $reg->ListarFormulasMedicasG();
...
<a class="btn btn-primary btn-xs" title="Editar" onClick="actualizar('editfmedicag?fm=<?php echo base64_encode($reg[$i]["codprocedimiento"]) ?>')"><i class="fa fa-pencil"></i></a>
                                 
<?php if ($_SESSION['acceso'] == "administrador"){ ?><a class="btn btn-danger btn-xs" onClick="eliminar('eliminar?<?php echo base64_encode('eliminar'); ?>&codformula=<?php echo base64_encode($reg[$i]["codformula"]) ?>&tipo=<?php echo base64_encode("FORMULASMEDICAS") ?>')" title="Eliminar" ><i class="fa fa-trash-o"></i></a><?php } ?></td>
											   </tr>
											   <?php } } ?>
											   </tbody>
</table>
