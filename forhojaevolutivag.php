...
<form class="form" method="post"  action="#" name="hojasevolutivasg" id="hojasevolutivasg" onSubmit="asigna()"> 
...
<button type="button" onClick="BuscarHojaEvolutivaG()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                          </div>
