...
<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><img src="assets/images/close.png"/></button> 
             <h3 class="panel-title"><i class="fa fa-align-justify"></i> Datos de Sucursal</h3> 
                                                        </div> 
...
<div class="panel-heading">
<h3 class="panel-title"><i class="fa fa-tasks"></i> Control de Sucursales<span class="pull-right">
		...
		if(isset($_GET["mesage"]))
{
	switch($_GET["mesage"])
	{
		...
		echo "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
		echo "<center><span class='fa fa-info-circle'></span> ESTA SUCURSAL NO PUEDE SER ELIMINADA, SE ENCUENTRA ASIGNADA A UNA CITA MEDICA </center>";  
		echo "</div>"; 
		break;
    ...
    echo "<div class='alert alert-warning'>";
    echo "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
    echo "<center><span class='fa fa-info-circle'></span> USTED NO PUEDE ELIMINAR SUCURSALES, NO ERES EL ADMINISTRADOR </center>";  
    echo "</div>"; 
    break;
...
<a class="btn btn-success btn-xs" data-placement="left" title="Ver" data-original-title="" data-href="#" data-toggle="modal" data-target="#panel-modal" data-backdrop="static" data-keyboard="false" onClick="VerSucursal('<?php echo base64_encode($reg[$i]["codsucursal"]); ?>')"><i class="fa fa-eye"></i></a>

<a class="btn btn-primary btn-xs" title="Editar" onClick="actualizar('forsucursal?codsucursal=<?php echo base64_encode($reg[$i]["codsucursal"]) ?>')"><i class="fa fa-pencil"></i></a>
                                 
<a class="btn btn-danger btn-xs" onClick="eliminar('eliminar?<?php echo base64_encode('eliminar'); ?>&codsucursal=<?php echo base64_encode($reg[$i]["codsucursal"]) ?>&tipo=<?php echo base64_encode("SUCURSALES") ?>')" title="Eliminar" ><i class="fa fa-trash-o"></i></a> </td>
											   </tr>
											   <?php } } ?>
											   </tbody>
</table>
