...
if ($_SESSION['acceso'] == "administrador" || $_SESSION["acceso"]=="enfermera" || $_SESSION["acceso"]=="tecnico" || $_SESSION["acceso"]=="radiologo") {
...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-search"></i> Búsqueda en Lectura Rx</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li><a href="lecturarx">Control</a></li>
<li class="active">Búsqueda en Lectura Rx</li>
</ol>
...
<form class="form" method="post"  action="#" name="buscareporteradiologia" id="buscareporteradiologia"> 
      

<div class="row">
<div class="col-sm-12">
<div class="panel panel-primary">
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-search"></i> Búsqueda en Lectura Rx</h3></div>
...
<button type="button" onClick="BuscarReporteRadiologia()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                          </div>
         ...
         <div id="muestrareporteradiologia"></div>
