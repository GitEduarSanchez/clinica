...
<form class="form" name="updateusuario" id="updateusuario" method="post" data-id="<?php echo $reg[0]["codigo"] ?>" action="#" enctype="multipart/form-data" >
  ...
  <label class="control-label">Tipo de Identificación: <span class="symbol required"></span></label>
                              <?php if (isset($reg[0]['tipoidentificacion'])) { ?>
<select name="tipoidentificacion" id="tipoidentificacion" class='form-control' required="" aria-required="true">
                                    <option value="">SELECCIONE</option>
<option value="REGISTRO CIVIL"<?php if (!(strcmp('REGISTRO CIVIL', $reg[0]['tipoidentificacion']))) {echo "selected=\"selected\"";} ?>>REGISTRO CIVIL</option>
<option value="TARJETA DE IDENTIDAD"<?php if (!(strcmp('TARJETA DE IDENTIDAD', $reg[0]['tipoidentificacion']))) {echo "selected=\"selected\"";} ?>>TARJETA DE IDENTIDAD</option>
<option value="CEDULA"<?php if (!(strcmp('CEDULA', $reg[0]['tipoidentificacion']))) {echo "selected=\"selected\"";} ?>>CEDULA</option>
<option value="CEDULA EXTRANJERA"<?php if (!(strcmp('CEDULA EXTRANJERA', $reg[0]['tipoidentificacion']))) {echo "selected=\"selected\"";} ?>>CEDULA EXTRANJERA</option> 
                                                    </select>
                             <?php } else { ?>  
<select name="tipoidentificacion" id="tipoidentificacion" class='form-control' required="" aria-required="true"> 
             <option value="">SELECCIONE</option>
...
<input type="text" class="form-control" name="cedula" id="cedula" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Nº de Identificación" <?php if (isset($reg[0]['cedula'])) { ?> value="<?php echo $reg[0]['cedula']; ?>"<?php } ?> required="" aria-required="true">
...
<input type="text" class="form-control" name="password2" id="password2" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Password de Acceso" required="" aria-required="true">
  ...
  <option value="ENFERMERO(A)"<?php if (!(strcmp('ENFERMERO(A)', $reg[0]['nivel']))) {echo "selected=\"selected\"";} ?>>ENFERMERO(A)</option>
  <option value="TEC RADIOLOGIA"<?php if (!(strcmp('TEC RADIOLOGIA', $reg[0]['nivel']))) {echo "selected=\"selected\"";} ?>>TECNICO RADIOLOGIA</option>
  <option value="MÉDICO ESPECIALISTA"<?php if (!(strcmp('MÉDICO ESPECIALISTA', $reg[0]['nivel']))) {echo "selected=\"selected\"";} ?>>MÉDICO ESPECIALISTA</option>
                      </select>
                             <?php } else { ?>  
<select name="nivel" id="nivel" class="form-control" required="" aria-required="true">
                        <option value="">SELECCIONE</option>
                        ...
                        <option value="TEC RADIOLOGIA">TECNICO RADIOLOGIA</option>
                        <option value="TEC RADIOLOGIA">MÉDICO ESPECIALISTA</option>
