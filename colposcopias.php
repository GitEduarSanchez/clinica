...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Control de Colposcopias</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li class="active">Colposcopias</li>
</ol>
...
<h3 class="panel-title"><i class="fa fa-tasks"></i> Control de Colposcopias<span class="pull-right"><a href="forcolposcopia" class="btn btn-default dropdown-toggle" data-toggle="tooltip" data-placement="left" title="" data-original-title="Nueva Colposcopia"><span class="fa fa-clipboard"></span> Nueva Colposcopia</a></span></h3>
</div>
		...
		if(isset($_GET["mesage"]))
{
	switch($_GET["mesage"])
	{
		...
		echo "<center><span class='fa fa-check-square-o'></span> LA COLPOSCOPIA FUE ELIMINADA EXITOSAMENTE </center>"; 
		echo "</div>";
		break;
    ...
    echo "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
    echo "<center><span class='fa fa-info-circle'></span> USTED NO PUEDE ELIMINAR COLPOSCOPIA, NO ERES EL ADMINISTRADOR </center>";  
    echo "</div>"; 
    break;
...
<a class="btn btn-primary btn-xs" title="Editar" onClick="actualizar('editcolposcopia?co=<?php echo base64_encode($reg[$i]["codcolposcopia"]) ?>')"><i class="fa fa-pencil"></i></a>
                                 
<?php if ($_SESSION['acceso'] == "administrador"){ ?><a class="btn btn-danger btn-xs" onClick="eliminar('eliminar?<?php echo base64_encode('eliminar'); ?>&codcolposcopia=<?php echo base64_encode($reg[$i]["codcolposcopia"]) ?>&tipo=<?php echo base64_encode("COLPOSCOPIAS") ?>')" title="Eliminar" ><i class="fa fa-trash-o"></i></a><?php } ?></td>
											   </tr>
											   <?php } } ?>
											   </tbody>
</table>
