...
$query=$db->query("select * from ".$tabla." where fechacita='".$_GET["fecha"]."' and codmedico='".$_SESSION['codmedico']."' order by codcita asc");
		if ($fila=$query->fetch_array())
		{
        	...
        	<th><div align='center'><strong>Paciente</strong></div></td>
        	<th><div align='center'><strong>Observaci&oacute;n</strong></div>
        	</td></tr>
        	</thead>";
        			do
        			{
...
<a class='actual' rel='$messiguiente'><button type='button' onclick='generar_calendario()' class='btn btn-default waves-effect'><label>Hoy</label></button></a>
