...
<form class="form" method="post"  action="#" name="laboratorio" id="laboratorio"> 

<div class="row">
<div class="col-sm-12">
<div class="panel panel-primary">
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-edit"></i> Gestión de Exámen Laboratorio</h3></div>
...
<button type="button" onClick="BuscarLaboratorio()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                          </div>
                        ...
                        <div id="muestralaboratorio"></div>
                        <div id="crearlaboratorio"></div>
