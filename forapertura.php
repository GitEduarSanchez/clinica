...
<span class="dropdown hidden-xs"><abbr title="<?php echo $_SESSION['nivel']; ?>"><?php echo $_SESSION['ingreso']; ?></abbr> </span>
  <?php
if($_SESSION["tipo"]=="1"){
...
<form class="form" method="post"  action="#" name="apertura" id="apertura" onSubmit="asigna()"> 
...
<div class="row"> 
  ...
  <div class="col-sm-12">
     <div class="panel panel-primary">
        <div class="panel-heading"><h3 class="panel-title"><i class="fa fa-edit"></i> Gestión de Aperturas</h3></div>
...
<button type="button" onClick="BuscarApertura()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>
            </div>
                        ...
                        <div id="muestraapertura"></div>
                        <div id="crearapertura"></div> 
