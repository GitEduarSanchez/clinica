          ...
          <div id="errorr">
           ...
           <div class="col-sm-12">
            <div class="form-group has-feedback">
              <label class="control-label">Seleccione Tipo: <span class="symbol required"></span></label>
              <select name="select" id="select" class="form-control" required="" aria-required="true">
               ...
               <option value="TEC RADIOLOGIA">TEC. RADIOLOGIA</option>
             </select></div></div>
    ...
    <header class="home">										
        ...
        <div class="wrapper-page">
         <div class="panel panel-color panel-primary panel-pages">
               ...
               <div class="form-group has-feedback">
                ...
                <div class="form-group has-feedback">
                  ...
                  <div class="form-group">
                    <div class="col-sm-7">
                      <a href="#" class="on-default centered" data-href="#" data-toggle="modal" data-target=".bs-example-modal-sm" data-placement="left" data-backdrop="static" data-keyboard="false" rel="tooltip" title="Recuperar Contraseña"><i class="fa fa-lock m-r-5"></i> ¿Olvidaste tu Password ?</a>                        
                    </div>
                    
                    <div class="col-sm-5 text-right link">
                      <a class="" data-container="body" title="" data-toggle="popover" data-placement="left" data-content="El Médico especialista deberá de ingresar su número de identificación como usuario" style="cursor: pointer;"><i class="fa fa-info-circle m-r-5"></i> Ayuda</a>
                    </div>
                  </div>
          ...
          <footer id="footer" name="footer">Poliedro Software<br> Software 2020<br><br><br><br></footer>
         </div>
</header>      <script>
            var resizefunc = [];
        </script>
