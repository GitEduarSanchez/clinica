...
<div class="panel-heading">
<h3 class="panel-title"><i class="fa fa-tasks"></i> Control de Aperturas de Historias<span class="pull-right"><a href="foraperturag" class="btn btn-default dropdown-toggle" data-toggle="tooltip" data-placement="left" title="" data-original-title="Nueva Apertura de Historia"><span class="fa fa-folder-open"></span> Nueva Apertura</a></span></h3>
</div>
...
<a class="btn btn-primary btn-xs" title="Editar" onClick="actualizar('editaperturag?a=<?php echo base64_encode($reg[$i]["codapertura"]) ?>')"><i class="fa fa-pencil"></i></a>
