...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-edit"></i> Gestión de Aperturas</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li><a href="aperturas">Control</a></li>
<li class="active">Gestión de Aperturas</li>
</ol>
...
<form class="form" name="updateaperturag" id="updateaperturag" method="post" data-id="<?php echo $reg[0]["codapertura"] ?>" action="#" onSubmit="asigna()"> 
...
<input type="hidden" name="codapertura" id="codapertura" value="<?php echo $reg[0]['codapertura']; ?>">
...
<textarea name="enfermedadpaciente" class="form-control" id="enfermedadpaciente" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Enfermedad Actual del Paciente" rows="2" required="" aria-required="true"><?php echo $reg[0]['enfermedadpaciente']; ?></textarea> 
                  <i class="fa fa-comment form-control-feedback"></i>
                </div> 
              </div>
            </div>
...
<textarea class="form-control" name="antecedentepaciente" id="antecedentepaciente" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Antecedentes Personales" rows="2" required="" aria-required="true"><?php echo $reg[0]['antecedentepaciente']; ?></textarea> 
                  <i class="fa fa-comment form-control-feedback"></i>
                </div> 
              </div>
...
<textarea class="form-control" name="antecedentefamiliares" id="antecedentefamiliares" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Antecedentes Familiares" rows="2" required="" aria-required="true"><?php echo $reg[0]['antecedentefamiliares']; ?></textarea> 
                  <i class="fa fa-comment form-control-feedback"></i>
                </div> 
              </div>
...
<textarea class="form-control" name="antecedentealergico" id="antecedentealergico" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Antecedentes Alérgico" rows="2" required="" aria-required="true"><?php echo $reg[0]['antecedentealergico']; ?></textarea> 
                  <i class="fa fa-comment form-control-feedback"></i>
                </div> 
              </div>
            </div>
...
<textarea class="form-control" name="antecedentepatologico" id="antecedentepatologico" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Antecedentes Patólogicos" rows="2" required="" aria-required="true"><?php echo $reg[0]['antecedentepatologico']; ?></textarea> 
                  <i class="fa fa-comment form-control-feedback"></i>
                </div> 
              </div>
...
<textarea class="form-control" name="antecedentequirurgico" id="antecedentequirurgico" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Antecedentes Quirúrgicos" rows="2" required="" aria-required="true"><?php echo $reg[0]['antecedentequirurgico']; ?></textarea> 
                  <i class="fa fa-comment form-control-feedback"></i>
                </div> 
              </div>
...
<textarea class="form-control" name="antecedentefarmacologico" id="antecedentefarmacologico" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Antecedentes Farmacológicos" rows="2" required="" aria-required="true"><?php echo $reg[0]['antecedentefarmacologico']; ?></textarea> 
                  <i class="fa fa-comment form-control-feedback"></i>
                </div> 
              </div>
            </div>

<?php if($reg[0]['sexopaciente']=="FEMENINO") { ?>
...
<textarea class="form-control" name="antecedenteginecologico" id="antecedenteginecologico" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Antecedentes Ginecológicos" rows="2" required="" aria-required="true"><?php echo $reg[0]['antecedenteginecologico']; ?></textarea> 
                  <i class="fa fa-comment form-control-feedback"></i>
                </div> 
              </div>
...
<textarea class="form-control" name="historialgestacional" id="historialgestacional" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Historial Gestacional" rows="2" required="" aria-required="true"><?php echo $reg[0]['historialgestacional']; ?></textarea> 
                  <i class="fa fa-comment form-control-feedback"></i>
                </div> 
              </div>
...
<textarea class="form-control" name="planificacionfamiliar" id="planificacionfamiliar" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Planificación Familiar" rows="2" required="" aria-required="true"><?php echo $reg[0]['planificacionfamiliar']; ?></textarea> 
                  <i class="fa fa-comment form-control-feedback"></i>
                </div> 
              </div>
            </div>
