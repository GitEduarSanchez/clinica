...
<li><a href="consentimientodo">Control</a></li>
...
<form class="form" method="post"  action="#" name="consentimientodo" id="consentimientodo"> 
...
<input type="hidden" name="especialidad" id="especialidad" value="ODONTOLOGIA">
  ...
  <div class="col-md-5"> 
    <div class="form-group has-feedback"> 
      ...
      <select name="codmedico" id="codmedico" class='form-control' required="" aria-required="true">
       ...
       <?php
       $med = new Login();
       $med = $med->ListarMedicosEspecialidadOdontologo();
...
<button type="button" onClick="BuscarConsentimientoDo()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                          </div>
