...
<h3 class="panel-title"><i class="fa fa-tasks"></i> Control de Órdenes Médicas<span class="pull-right"><a href="foromedica" class="btn btn-default dropdown-toggle" data-toggle="tooltip" data-placement="left" title="" data-original-title="Nueva Órden"><span class="fa fa-file-text"></span> Nueva Órden</a></span></h3>
</div>
...
<a class="btn btn-primary btn-xs" title="Editar" onClick="actualizar('editomedica?om=<?php echo base64_encode($reg[$i]["codprocedimiento"]) ?>')"><i class="fa fa-pencil"></i></a>
