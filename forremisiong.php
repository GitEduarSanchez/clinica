...
<form class="form" method="post"  action="#" name="remisionesg" id="remisionesg" onSubmit="asigna()"> 
...
<button type="button" onClick="BuscarRemisionesG()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                          </div>
