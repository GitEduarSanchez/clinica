...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-edit"></i> Gestión de Citas Médicas</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li><a href="citas">Control</a></li>
<li class="active">Gestión de Citas Médicas</li>
</ol>
...
<form class="form" method="post"  action="#" name="citas" id="citas"> 
...
<input type="text" id="valor" name="valor" onKeyUp="this.value=this.value.toUpperCase();" class="form-control" placeholder="Ingrese Nº Identificación o Nombre para la Búsqueda de Pacientes" required="" aria-required="true">
            ...
            <div class="modal-footer"> 
<button type="button" onClick="BuscarPacientes()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                          </div>
         ...
         <div id="muestrapacientecitas"></div>
