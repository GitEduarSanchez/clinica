...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Citas por Fechas</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li class="active">Citas por Fechas</li>
</ol>
...
<form class="form" method="post"  action="#" name="buscacitasreportes" id="buscacitasreportes"> 
      

<div class="row">
<div class="col-sm-12">
<div class="panel panel-primary">
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-edit"></i> Citas por Fechas</h3></div>
...
<select name="especialidad" id="especialidad" class="form-control" required="" aria-required="true">
                                <option value="">SELECCIONE</option>
...
<button type="button" onClick="BuscaCitasFechas()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                          </div>
         ...
         <div id="muestracitasmedicasreportes"></div>
