...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-edit"></i> Gestión de Lectura Rx</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li><a href="lecturarx">Control</a></li>
<li class="active">Gestión de Lectura Rx</li>
</ol>
...
<textarea name="diagnosticorx" class="form-control" id="diagnosticorx" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Diagnóstico de Lectura RX" rows="12" required="" aria-required="true"><?php echo $reg[0]['diagnosticorx']; ?></textarea> 
