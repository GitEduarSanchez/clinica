...
<form class="form" method="post"  action="#" name="examenes" id="examenes" onSubmit="asigna()"> 

<div class="row">
<div class="col-sm-12">
<div class="panel panel-primary">
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-edit"></i> Gestión de Solicitud Exámenes</h3></div>
...
<button type="button" onClick="BuscarSolicitud()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                          </div>
                        ...
                        <div id="muestrasolicitudexamen"></div>
                        <div id="crearsolicitudexamen"></div>
