...
{
$reg = $tra->RegistrarHojaEvolutiva();
exit;
}
?>
<!DOCTYPE html>
...
<form class="form" method="post"  action="#" name="hojasevolutivas" id="hojasevolutivas" onSubmit="asigna()"> 

<div class="row">
<div class="col-sm-12">
<div class="panel panel-primary">
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-edit"></i> Gestión de Hojas Evolutivas</h3></div>
...
<button type="button" onClick="BuscarHojaEvolutiva()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                          </div>
                        ...
                        <div id="muestrahojaevolutiva"></div>
                        <div id="crearhojaevolutiva"></div>
