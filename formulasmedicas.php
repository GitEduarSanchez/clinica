...
<h3 class="panel-title"><i class="fa fa-tasks"></i> Control de Fórmulas Médicas<span class="pull-right"><a href="forfmedica" class="btn btn-default dropdown-toggle" data-toggle="tooltip" data-placement="left" title="" data-original-title="Nueva Fórmula"><span class="fa fa-file-text"></span> Nueva Fórmula</a></span></h3>
</div>
...
<a class="btn btn-primary btn-xs" title="Editar" onClick="actualizar('editfmedica?fm=<?php echo base64_encode($reg[$i]["codprocedimiento"]) ?>')"><i class="fa fa-pencil"></i></a>
