...
{
$reg = $tra->ActualizarOrdenesMedicas();
exit;
}
?>
<!DOCTYPE html>
...
<form class="form" name="updateordenmedicag" id="updateordenmedicag" method="post" data-id="<?php echo $reg[0]["codprocedimiento"] ?>" action="#" onSubmit="asigna()"> 
...
<input name="codorden" type="hidden" id="codorden" value="<?php echo $reg[0]['codorden']; ?>" />
