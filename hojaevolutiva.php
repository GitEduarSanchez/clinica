...
<h3 class="panel-title"><i class="fa fa-tasks"></i> Control de Hojas Evolutivas<span class="pull-right"><a href="forhojaevolutiva" class="btn btn-default dropdown-toggle" data-toggle="tooltip" data-placement="left" title="" data-original-title="Nueva Hoja Evolutiva"><span class="fa fa-clipboard"></span> Nueva Hoja</a></span></h3>
</div>
...
<a class="btn btn-primary btn-xs" title="Editar" onClick="actualizar('edithojaevolutiva?h=<?php echo base64_encode($reg[$i]["codprocedimiento"]) ?>')"><i class="fa fa-pencil"></i></a>
