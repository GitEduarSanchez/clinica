...
<li><a href="consentimientogen">Control</a></li>
...
<form class="form" method="post"  action="#" name="consentimientogeneral" id="consentimientogeneral"> 
...
<input type="hidden" name="tipom" id="tipom" value="0">
<input type="hidden" name="especialidad" id="especialidad" value="MEDICO GENERAL">
...
<button type="button" onClick="BuscarConsentimientoGeneral()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                          </div>
