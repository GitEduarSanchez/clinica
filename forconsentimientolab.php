...
<li><a href="consentimientolab">Control</a></li>
...
<form class="form" method="post"  action="#" name="consentimientolab" id="consentimientolab"> 
...
<input type="hidden" name="especialidad" id="especialidad" value="BACTERIOLOGO">
...
<button type="button" onClick="BuscarConsentimientoLab()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                          </div>
