...
<form class="form" method="post"  action="#" name="ordenesmedicasg" id="ordenesmedicasg" onSubmit="asigna()"> 
...
<button type="button" onClick="BuscarOrdenesMedicasG()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                          </div>
